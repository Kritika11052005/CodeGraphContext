...
class JavascriptToolkit:
    """Cypher queries for JavaScript graph data."""
    ...
    def get_cypher_query(self, query: str) -> str:
        ...
        if query == "Repository":
            return """
                ...
                WHERE f.path ENDS WITH '.js' OR f.path ENDS WITH '.jsx' OR f.path ENDS WITH '.mjs' OR f.path ENDS WITH '.cjs'
